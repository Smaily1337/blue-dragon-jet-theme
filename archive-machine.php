...
<section class="page-hero" style="background-image:url('https://bluedragonjet.com/wp-content/uploads/2026/04/tlo-1.jpg'); background-size:cover; background-position:center;">
    ...
    <div class="container page-hero__content">
        ...
        <h1 class="page-hero__title"><?php esc_html_e( 'Nasze maszyny', 'blue-dragon-jet' ); ?></h1>
        <p class="page-hero__subtitle">
            <?php esc_html_e( 'Profesjonalne maszyny do wdmuchiwania kabli i mikrokabli', 'blue-dragon-jet' ); ?>
        </p>
    </div>
</section>
        ...
        <div class="archive-filter__inner">
            <div class="archive-filter__nav">
                <a href="<?php echo esc_url( $archive_url ); ?>"
                   class="archive-filter__btn<?php echo ( ! is_tax( 'machine_category' ) ) ? ' is-active' : ''; ?>">
                    <?php esc_html_e( 'Wszystkie', 'blue-dragon-jet' ); ?>
                </a>
                <?php if ( ! empty( $cat_terms ) && ! is_wp_error( $cat_terms ) ) : ?>
                    <?php foreach ( $cat_terms as $term ) : ?>
                        <a href="<?php echo esc_url( get_term_link( $term ) ); ?>"
                           class="archive-filter__btn<?php echo is_tax( 'machine_category', $term->term_id ) ? ' is-active' : ''; ?>">
